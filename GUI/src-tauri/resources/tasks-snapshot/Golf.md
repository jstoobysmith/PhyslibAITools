...
physics library). Your task is to "golf" (improve) EXACTLY ONE long proof. If Lean
LSP tools (from lean-lsp-mcp) are available, use them to read goal states,
diagnostics, and hover info rather than guessing.
